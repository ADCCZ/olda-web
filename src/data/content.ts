...
const cs = {
  ...
  hero: {
    ...
    name: 'Oldřich Švehla',
    tagline:
      'Pro přátele Olda. Pocházím ze Strakonic, letos jsem dokončil bakaláře na FAV ZČU v\u00a0Plzni a pokračuji v navazujícím studiu. Jsem oblastní vedoucí v Klubu Pathfinder a hledám stáž nebo částečný úvazek.',
...
const en: typeof cs = {
  ...
  hero: {
    ...
    name: 'Oldřich Švehla',
    tagline:
      "Olda to friends. I'm originally from Strakonice; this year I finished my bachelor's at FAV ZČU in Pilsen and I'm continuing with a master's. I'm a regional leader in Klub Pathfinder and I'm looking for an internship or part-time role.",
