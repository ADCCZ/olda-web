...
const cs = {
  ...
  guitar: {
    ...
    accomp: 'Doprovod',
    progression: 'Průběh',
    progressions: { camp: 'Táborák', pop: 'Pop', folk: 'Folk', blues: 'Blues v E', current: 'jen tenhle akord' },
    rhythm: 'Rytmus',
    patterns: { camp: 'Táborák', eighths: 'Osminy', waltz: 'Valčík 3/4', picking: 'Prstoklad' },
    tempo: 'Tempo',
...
const en: typeof cs = {
  ...
  guitar: {
    ...
    progressions: { camp: 'Campfire', pop: 'Pop', folk: 'Folk', blues: 'Blues in E', current: 'this chord only' },
    rhythm: 'Rhythm',
    patterns: { camp: 'Campfire', eighths: 'Eighths', waltz: 'Waltz 3/4', picking: 'Fingerpicking' },
    tempo: 'Tempo',
