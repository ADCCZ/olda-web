  ...
  return (
    <Section id="contact" title={t.contact.title}>
      <div className="flex flex-wrap items-start gap-6">
        <p className="max-w-prose text-lg leading-snug md:text-xl">{t.contact.lead}</p>
        <span className="stamp mt-2 text-sm">{t.contact.stamp}</span>
      </div>
      <dl className="mt-8 grid max-w-md grid-cols-[auto_1fr] gap-x-6 gap-y-1 font-mono text-sm">
