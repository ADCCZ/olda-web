...
DATA = {
    ...
    'projects': [
        ...
        ('Vizualizace regionálních otevřených dat', 'Bakalářská práce. Zpracování, analýza a interaktivní vizualizace otevřených datových sad.',
         'otevřená data, vizualizace, Python, web', ''),
